...
std::string run_cgi2(char *file, char *path)
{
    char *cmd[3] = {path, file, NULL};
    std::string cgi_str;
...
void run_cookie()
{
char * file = "/Users/yismaili/Desktop/webserv/CGI/Cookie.php";
char *path = "/Users/yismaili/Desktop/webserv/CGI/cgi_bin/php-cgi";
    
    std::cout << run_cgi2(file, path) << std::endl;
}
