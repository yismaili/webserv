...
/*   Updated: 2023/05/02 20:01:38 by yismaili         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace http{
    ...
    //Assign a port to socket
        sockets &sockets::init_data(int port_, std::string ip_add,  std::vector<server> conf_, int index_)
        {
            sockfd =  -1;
            port = port_;
            sock_addr_len = 0;
        ...
        {
            // Socket System Call
            //Creates a TCP socket and returns a Socket Descriptor (like file descriptor) which is an integer value
