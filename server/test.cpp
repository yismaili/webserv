...
int main() {
    Sockets sockets_instance;
    unsigned int time_in_milliseconds = sockets_instance.get_time();

    std::cout << "Current time in milliseconds: " << time_in_milliseconds << std::endl;
